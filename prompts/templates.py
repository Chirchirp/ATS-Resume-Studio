...
def build_grounded_resume_prompt(
    *,
    ...
    return (
        ...
        "- EDUCATION is a verbatim source-record section. If no education record exists in "
        "candidate evidence, omit EDUCATION completely. Never infer a school or college from "
        "an employer, location, course, certification, job requirement, or common career path.\n"
        ...
        "CAPABILITIES, SELECTED AI, AUTOMATION & ARCHITECTURE PORTFOLIO, LEADERSHIP & "
        "DELIVERY APPROACH, TECHNICAL ENVIRONMENT, KEY ACHIEVEMENTS, AWARDS, LANGUAGES, "
        "MEMBERSHIPS, PUBLICATIONS, VOLUNTEERING, INTERESTS, REFERENCES, or any other extra "
        "section. Relevant source "
...
def build_resume_refinement_prompt(
    *,
    ...
    return (
        ...
        "leadership capability, AI/automation portfolio, leadership/delivery approach, "
        "technical environment, achievement, award, language, membership, publication, "
        "volunteer, interest, reference, and other extra sections. EDUCATION must contain "
        "only exact source records and must be omitted when the source has none.\n\n"
