...
def build_grounded_resume_prompt(
    *,
    ...
    return (
        ...
        "- Preserve supplied training, awards, languages, memberships, publications, "
        "and volunteer records under their own standard headings; do not absorb them "
        "into another section or silently discard them.\n"
        ...
        "- Build CORE SKILLS as 3-5 readable category lines (for example tools, analytics, "
        ...
        "shortest skills line or copy missing JD keywords.\n"
...
def build_resume_refinement_prompt(
    *,
    ...
    return (
        ...
        "7. Format: preserve the Evidence and JD Match audit lines exactly. They will "
